...
var items = new vis.DataSet([
  ...
  {id: 8, content: 'OmniPath', start: '2016-11-01', group: 'Database', title: 'OmniPath — Meta-resource: 100+ signaling databases unified (Nat Methods, 2016)', style: 'background-color: #FFF9C4;'},
  ...
  {id: 27, content: 'AlphaPept', start: '2024-01-01', group: 'Identification', title: 'AlphaPept — Open-source Python proteomics pipeline (Nat Comm, 2024)', style: 'background-color: #BBDEFB;'},
